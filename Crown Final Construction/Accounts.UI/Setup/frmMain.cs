...
namespace Accounts.UI
{
    public partial class frmMain : Form
    {
        ...
        #endregion
        #region Construction
        frmBlocks frmbuildingblock;
        private void rbnBtnCreateBlocks_Click(object sender, EventArgs e)
        {
            frmbuildingblock = new frmBlocks();
            frmbuildingblock.MdiParent = this;
            frmbuildingblock.Show();
        }
        frmLevelGrids frmlevelgrid;
        private void rbnBtnCreateGrids_Click(object sender, EventArgs e)
        {
            frmlevelgrid = new frmLevelGrids();
            frmlevelgrid.MdiParent = this;
            frmlevelgrid.Show();
        }
        #endregion
        #region Construction Reports
        frmInventoryIssuanceLocation frmmateriallocationusagereport;
        private void rbnBtnProductLocationReport_Click(object sender, EventArgs e)
        {
            frmmateriallocationusagereport = new frmInventoryIssuanceLocation();
            frmmateriallocationusagereport.MdiParent = this;
            frmmateriallocationusagereport.Show();
        }
        #endregion
        #region Exit
        ...
        #endregion
        frmStoreMaterialsCostingReports frmcostingmaterials;
        private void rbnBtnCostingReport_Click(object sender, EventArgs e)
        {
            frmcostingmaterials = new frmStoreMaterialsCostingReports();
            frmcostingmaterials.MdiParent = this;
            frmcostingmaterials.Show();
        }

    ...
    public partial class frmGatePassReports : MetroForm
    {
        ...
        private void ShowAndGridColumns()
        {
            ...
            else if (ddlReportTypes.SelectedIndex == 3)
            {
                ...
                grdReports.Columns[8].Visible = false; // PersonNameColumn
            ...
            else if (ddlReportTypes.SelectedIndex == 4)
            {
                ...
                grdReports.Columns[8].Visible = true; // PersonNameColumn
            }
        }
        #endregion
        ...
        private void BindIssuanceGridByCode(List<VoucherDetailEL> list, short BindingCode)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                if (BindingCode == 1)
                {
                    ...
                    grdReports.Rows[i].Cells[5].Value = list[i].BlockName;
                    grdReports.Rows[i].Cells[6].Value = list[i].LevelName;
                    grdReports.Rows[i].Cells[7].Value = list[i].GridName;
                    grdReports.Rows[i].Cells[8].Value = list[i].UnitPrice;
                    grdReports.Rows[i].Cells[9].Value = list[i].Amount;
                }
        ...
        private void FillComboDetail()
        {
            ...
            ddlReportTypes.Items.Insert(1, "Contractor Issuance Report");

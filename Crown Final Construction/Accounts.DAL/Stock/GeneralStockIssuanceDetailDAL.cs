    ...
    public class GeneralStockIssuanceDetailDAL
    {
        ...
        public bool CreateGeneralInventoryIssuanceDetail(List<VoucherDetailEL> oelIssuanceCollection, Int64? Identity, SqlConnection objConn, SqlTransaction oTran)
        {
            ...
            for (int i = 0; i < oelIssuanceCollection.Count; i++)
            {
                ...
                cmdIssuanceDetail.Parameters.Add(new SqlParameter("@IdGrid", DbType.Int64)).Value = oelIssuanceCollection[i].IdGrid;
                ...
                cmdIssuanceDetail.Parameters.Add(new SqlParameter("@MIR", DbType.Decimal)).Value = oelIssuanceCollection[i].MIR;
                cmdIssuanceDetail.Parameters.Add(new SqlParameter("@FlatUnitPrice", DbType.Decimal)).Value = oelIssuanceCollection[i].CurrentUnitPrice;
        ...
        public List<VoucherDetailEL> GetEmployeeIssuanceReport(string AccountNo, Int64 IdProject, SqlConnection objConn)
        {
            ...
            using (SqlCommand cmdPrescriberSale = new SqlCommand("[Transactions].[Proc_GetEmployeeIssuance]", objConn))
            {
                ...
                while (objReader.Read())
                {
                    ...
                    oelSaleDetail.BlockName = Validation.GetSafeString(objReader["Block_Name"]);
                    oelSaleDetail.LevelName = Validation.GetSafeString(objReader["Level_Name"]);
                    oelSaleDetail.GridName = Validation.GetSafeString(objReader["Grid_Name"]);
